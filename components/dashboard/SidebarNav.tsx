  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        ...
        <path d="M5 8h6M5 6h4" stroke="#003A8C" strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        ...
        <path d="M5 9h6M5 11h4" stroke="#003A8C" strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        ...
        <path d="m1.5 4 6.5 5 6.5-5" stroke="#003A8C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        ...
        <path d="m5 9 1.5 1.5L11 7" stroke="#003A8C" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  },
  {
      ...
      {NAV_LINKS.map((link) => {
        ...
        return (
          ...
          >
            ...
            {link.label}
            {isActive && (
              <span className="ml-auto h-1.5 w-1.5 rounded-full bg-white/60" aria-hidden="true" />
            )}
          </Link>
        );
      })}
